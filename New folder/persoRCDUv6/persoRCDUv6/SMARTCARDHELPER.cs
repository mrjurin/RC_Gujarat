  ...
  public class SMARTCARDHELPER
  {
    ...
    public bool WriteOnCurrentSelectedFile(uint ScHandle, uint ScProto, string HexInputData, string StartIndex, ref string ErrMsg)
    {
      try
      {
        ...
        for (; num1 < num3; ++num1)
        {
          string Command = "00D0" + StartIndex + "FA" + HexInputData.Substring(startIndex, 500).ToString();
        ...
        string Command1 = "00D0" + StartIndex + num5.ToString("X").PadLeft(2, '0') + HexInputData.Substring(startIndex, num5 * 2).ToString();
